...
ApplyScriptDefaultsOnGameSettings(jsonData) {
    ...
    jsonData['hotkey_areas']['value'] := ;
    CheckVK(GameKeys.GetHotkeyVK("OpenAreas") + 0.0)
    jsonData['hotkey_artifact_blazing_skull']['value'] := ;
    CheckVK(GameKeys.GetHotkeyVK("TriggerBlazingSkull") + 0.0)
    jsonData['hotkey_artifact_gold_suitcase']['value'] := ;
    CheckVK(GameKeys.GetHotkeyVK("TriggerSuitcase") + 0.0)
    jsonData['hotkey_artifact_gravity_ball']['value'] := ;
    CheckVK(GameKeys.GetHotkeyVK("TriggerGravity") + 0.0)
    jsonData['hotkey_artifact_seed_bag']['value'] := ;
    CheckVK(GameKeys.GetHotkeyVK("TriggerSeeds") + 0.0)
    jsonData['hotkey_artifact_vital_violin']['value'] := ;
    CheckVK(GameKeys.GetHotkeyVK("TriggerViolin") + 0.0)
    jsonData['hotkey_artifact_wind']['value'] := ;
    CheckVK(GameKeys.GetHotkeyVK("TriggerWind") + 0.0)
    jsonData['hotkey_artifact_wings']['value'] := ;
    CheckVK(GameKeys.GetHotkeyVK("TriggerWobblyWings") + 0.0)
    jsonData['hotkey_alchemy']['value'] := ;
    CheckVK(GameKeys.GetHotkeyVK("OpenAlchemy") + 0.0)
    jsonData['hotkey_banks']['value'] := ;
    CheckVK(GameKeys.GetHotkeyVK("OpenBank") + 0.0)
    jsonData['hotkey_borbventures']['value'] := ;
    CheckVK(GameKeys.GetHotkeyVK("OpenBorbVentures") + 0.0)
    jsonData['hotkey_cards']['value'] := ;
    CheckVK(GameKeys.GetHotkeyVK("OpenCards") + 0.0)
    jsonData['hotkey_crafting']['value'] := ;
    ...
    CheckVK(GameKeys.GetHotkeyVK("OpenGemShop") + 0.0)
    jsonData['hotkey_trading']['value'] := ;
    CheckVK(GameKeys.GetHotkeyVK("OpenTrades") + 0.0)
