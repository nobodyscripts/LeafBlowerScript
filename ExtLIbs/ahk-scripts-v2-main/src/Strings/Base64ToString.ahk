...
Base64ToString(Base64)
{
	...
	Stringvar := Buffer(Size)
	if !(DllCall("crypt32\CryptStringToBinaryW", "Str", Base64, "UInt", 0, "UInt", CRYPT_STRING_BASE64, "Ptr", Stringvar, "UInt*", Size, "Ptr", 0, "Ptr", 0))
		throw OSError()

	return StrGet(Stringvar, "UTF-8")
}
